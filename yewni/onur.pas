...
uses
  onurctrl, onurpanel, onuredit, onurpage, onurlist, onurbutton, onurmenu, 
  onurskin, onurslider, LazarusPackageIntf;
...
begin
  ...
  RegisterUnit('onurskin',@onurskin.Register);
  RegisterUnit('onurslider',@onurslider.Register);
end;
