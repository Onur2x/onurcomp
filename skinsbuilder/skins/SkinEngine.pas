...
{*******************************************************************}
{
 $Id: SkinEngine.pas,v 1.1.1.1 2003/03/21 12:12:44 evgeny Exp $                                                            
}
...
uses
  ...
  Menus, ExtCtrls, ImgList, StdCtrls, KSDevBmp, KsHook, SkinConst, SkinTypes,
  SkinObjects, SkinSource, SkinMenuWnd;
...
begin
  ...
  if LowerCase(ExtractFileExt(FSkinFile)) = '.kse' then
  begin
    { Load from folder }
