...
uses
  test,Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
                        ...
                        begin
                                ...
                                begin
                                        ...
                                        for i:=0 to SENode.Count-1   do
                                                TSkinObjet(SENode.Item[i].Data).nom:=KeyValue+'\'+ExtractFileName(TSkinObjet(SENode.Item[i].Data).nom);
                                        //puis le panel
