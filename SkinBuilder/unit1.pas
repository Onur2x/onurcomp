...
type
  ...
  Tskinsbuildier = class(TForm)
    ...
    procedure ColorBox2Exit(Sender: TObject);
    procedure ColorBox3Change(Sender: TObject);
    procedure ColorBox3Exit(Sender: TObject);
    ...
    procedure NumbereditEditingDone(Sender: TObject);
...
procedure Tskinsbuildier.ColorBox3Change(Sender: TObject);
begin
  infoedit.Cells[infoedit.Selection.Left, infoedit.Selection.Top] :=
    ColorToString(colorbox3.Selected);
end;

procedure Tskinsbuildier.ColorBox3Exit(Sender: TObject);
begin
  colorbox3.Visible := False;
end;

procedure Tskinsbuildier.NumbereditChange(Sender: TObject);
begin
  //PropEdit.Cells[PropEdit.Selection.Left, PropEdit.Selection.Top] := Numberedit.Text;
end;

procedure Tskinsbuildier.NumbereditEditingDone(Sender: TObject);
begin
  PropEdit.Cells[PropEdit.Selection.Left, PropEdit.Selection.Top] := Numberedit.Text;
end;


procedure Tskinsbuildier.ColorBox2Change(Sender: TObject);
begin
  PropEdit.Cells[PropEdit.Selection.Left, PropEdit.Selection.Top] :=
    ColorToString(colorbox2.Selected);
end;

procedure Tskinsbuildier.ColorBox2Exit(Sender: TObject);
begin
...
procedure Tskinsbuildier.PropEditSelectCell(Sender: TObject;
  aCol, aRow: integer; var CanSelect: boolean);
var
  crect: TRect;
begin
  ...
  begin
    colorbox2.Visible := False;
    crect := PropEdit.CellRect(ACol, ARow);
    Numberedit.Top := PropEdit.Top + crect.Top - 2;
    Numberedit.Left := PropEdit.Left + crect.Left - 2;
    Numberedit.Width := crect.Right - crect.Left + 5;
...
procedure Tskinsbuildier.PropEditExit(Sender: TObject);
begin
  Numberedit.Visible := False;
  colorbox2.Visible := False;
end;
